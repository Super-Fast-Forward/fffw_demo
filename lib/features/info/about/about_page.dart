  ...
  Widget build(BuildContext context, WidgetRef ref) {
    return PageLayout(title: 'About', sections: [
      SectionLayout(children: [
        ...
        const Text('FFFW is a framework for building Flutter apps with Firebase'
        ...
        const Text('The project is open source and can be found on GitHub:'),
        const Link(
      ...
      SectionLayout(children: [
        ...
        const Text('Currently the framework is not yet published on pub.dev.'
